...
$TccPatch4 = Join-Path $PSScriptRoot "0004-win32-restore-shell-drag-drop-declarations.patch"
$TccPatch5 = Join-Path $PSScriptRoot "0005-win32-declare-freopen_s.patch"
